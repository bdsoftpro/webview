...
import (
	...
	"github.com/bdsoftpro/webview/internal/w32"
	"github.com/bdsoftpro/webview/pkg/edge"
...
type WebViewOptions struct {
	...
	// User agent specifies the browser for the WebView2 runtime to use for the
	// browser instance.
	UserAgent string
...
func NewWithOptions(options WebViewOptions) WebView {
	...
	// Force put User Agent
	err = settings.PutUserAgent(options.UserAgent)
	if err != nil {
		log.Fatal(err)
	}
